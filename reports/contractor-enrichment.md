...
- SAM.gov-resolved entities: **60** (**80.0%** coverage)
...
A SAM.gov registration is authoritative for the returned entity identifiers, but it does not establish capability, performance quality, or intent to pursue an opportunity.
