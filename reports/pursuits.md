...
- Active pursuits and candidates: **1**
- Analyst-managed: **0**
...
Auto-seeded cards are candidates, not approved pursuits. Add an entry to `pursuits.yaml` for public tracking or `pursuits.local.yaml` for private execution, then assign an owner, decision date, milestones, and checklist.
