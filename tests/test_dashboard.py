...
class DashboardBuildTests(unittest.TestCase):
    ...
    def test_dashboard_includes_browser_local_analyst_decision_center(self) -> None:
        ...
        self.assertIn("high-probability", script)
        self.assertIn("forecast-heading-copy", script)
        self.assertIn("Horizon ·", script)
        self.assertIn('id="forecast-watch-module"', html)
        self.assertIn('id="forecast-preview"', html)
        self.assertIn("Click to expand", html)
        ...
        self.assertIn("recentlyClearedChanges", script)
        self.assertIn("Nothing needs analyst action right now", script)
        self.assertIn("Resolved, superseded, and retracted corrections", script)
        ...
        self.assertIn("buildBriefingHighlights", script)
        self.assertIn("meaningfulChangeHighlights", script)
        self.assertIn("materialAlertHighlights", script)
        self.assertIn("decisionHighlights", script)
        self.assertIn("isDuplicateHighlight", script)
        self.assertIn("No material changes today", script)
        self.assertIn("Today’s intelligence", html)
        self.assertIn("The developments most likely to change a decision", html)
